...
function addPlayer(
  ...
  if (
    !validationSuite(playerHandleInput, playerWinInput, playerLossInput, false)
  ) {
    return false;
  }
  addPlayerToArray(
...
const editPlayer = (
  ...
  if (
    !validationSuite(playerHandleInput, playerWinInput, playerLossInput, true)
  ) {
    return false;
  }
  editPlayerInArray(
  ...
  document.getElementById(
    "player-index-" + editedPlayerIndex
...
const revealEditForm = (
  ...
  document.getElementById(
    "player-index-" + revealEditFormIndex
  ).style.backgroundColor = "#D0ECF0";
  let editFormHTML = "";
  editFormHTML += `
...
mySelect.onchange = () => {
  ...
  switch (mySelect.value) {
    ...
    case "wins":
      ...
      printList();
      document.getElementById("player-index-0").style.backgroundColor =
        "#C9B037";
      document.getElementById("player-index-1").style.backgroundColor =
        "#D7D7D7";
      document.getElementById("player-index-2").style.backgroundColor =
        "#AD8A56";
      break;
    case "winrate":
      console.log("Please sort by handle");
